...
| Both (Personality + Design) | `#e84672` (igual que Design; canal rayado pendiente) |
| Inactive (skeleton) | `#dadce0` (gris claro, siempre visible) |
| Marcador de puerta activa (fill) | `#1c2540` (navy) |
