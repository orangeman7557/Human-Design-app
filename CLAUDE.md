...
- **Señales + cruz de encarnación (2026-07-22):** los dos datos que faltaban frente a las apps de referencia. Las **señales** (alineamiento/desalineamiento) son una tarjeta con dos valores compuesta desde el tipo — se llaman así a propósito, y «firma»/«tema del no-yo» solo se menciona dentro del drawer. La **cruz de encarnación** (`chart.cross`) muestra ángulo + las cuatro puertas Sol/Tierra y compone su significado desde las esencias de esas puertas: **los ~768 nombres canónicos son una tanda aparte, todavía pendiente**. El informe estrena sección **«Tu propósito»**, colocada tras «Vivir tu diseño» y subordinada a ella a propósito.
