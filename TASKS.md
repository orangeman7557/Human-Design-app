...
- **Phase L — Launch (→ 1.0).** 🟡 Pre-launch hardening pass that gates the 1.0
  ...
  **Step 6 (privacy policy) done 2026-07-03** — prerendered `/privacy` page
  ...
  Only step 5 (Ko-fi, optional) is left before the 1.0.0 bump (step 7).
