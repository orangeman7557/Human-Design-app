...
Last updated: 2026-08-10 (v1.5.4 — etiquetas y buscador de cartas guardadas + retoques de texto).

> Latest change (2026-08-10, **versión 1.5.4 — etiquetas y buscador de cartas guardadas, y dos retoques de texto**): construido y **verificado en el navegador** (asignar/renombrar/eliminar reflejan en las cartas, filtrado por nombre/tipo/lugar/etiqueta insensible a acentos, recientes, semilla de etiquetas por defecto). 40/40 tests, build sin avisos. Cerrado con bump a **1.5.4** y merge a `staging` **y a `main`**.
