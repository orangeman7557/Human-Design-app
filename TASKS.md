...
> **Verificado**: prompts generados a mano para la carta del autor en **ES y EN** (tipo, estrategia, autoridad, centro, puerta activa/colgante/inactiva, canal, cruz, señales, planeta, bodygraph, perfil, informe) y el camino sin enlace intacto. **40/40 tests**, build sin avisos nuevos. Sin cambio de versión (sigue 1.5.4). Merge a `staging` y a `main`.
>
