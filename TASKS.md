...
Last updated: 2026-08-19 (prompts «sobre esta carta» vuelven a ser específicos; merge a `staging` y a `main`).

> Latest change (2026-08-19, **los prompts «sobre esta carta» vuelven a ser específicos de la carta**): el enlace compartible (1.5.3, ago 2026) se había llevado por delante el ángulo de carta. Al añadir el enlace, `buildPrompts` **sustituía el prompt de carta por el general** y le pegaba la URL al final, así que «Sobre esta carta» e «Info general» decían literalmente lo mismo y solo se distinguían por el enlace.
