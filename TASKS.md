...
Last updated: 2026-08-09 (v1.5.3 + retoques de texto + etiquetas y buscador de cartas guardadas).

> Latest change (2026-08-09, **etiquetas + buscador de cartas guardadas, y dos retoques de texto**): construido y **verificado en el navegador** (asignar/renombrar/eliminar reflejan en las cartas, filtrado por nombre/tipo/lugar/etiqueta, recientes, semilla de etiquetas por defecto). 40/40 tests, build sin avisos. Mergeado a `staging` (sin bump; **`main` pendiente**).
