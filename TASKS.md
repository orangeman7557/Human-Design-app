...
Last updated: 2026-08-09 (v1.5.3).

> Latest change (2026-08-09, **versión 1.5.3 — enlace compartible para IA (embed + hora) y resúmenes de las 112 cruces**): validado en vivo por el autor (ChatGPT lee el enlace, hora correcta, textos de cruces revisados) y cerrado con bump a **1.5.3** y merge a `staging` **y a `main`**.
