...
- **Phase L — Launch (→ 1.0).** 🟡 Pre-launch hardening pass that gates the 1.0
  ...
  robots.txt, sitemap.xml, and `WebApplication` JSON-LD. Absolute URLs still point
  at the workers.dev domain — update `SITE_URL` + robots + sitemap at step 3.
