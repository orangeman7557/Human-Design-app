...
<button class="link" type="button" onclick={() => (open = true)}>acerca de<svg class="heart" viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round">
