...
//
// British spelling ("centre", "recognise") to match the app's English SEO copy.
...
const overrides = {
  ...
  promptTemplates: {
    ...
    who: 'a {type} with a {profile} profile, {authority} authority, {definition}, and these defined centres: {centers}',
    none: 'none',
    ...
    channel: {
      subject: 'channel {a}-{b}',
      complete: ', which in this chart is complete (it defines both of its centres)',
    ...
    concept: {
      ...
      centerGeneral:
        'what the nine centres are and what difference it makes to have them defined or undefined',
      centerChart: 'what the combination of defined and undefined centres in this chart implies',
  ...
  drawer: {
    ...
    gateInactive:
      'In this chart, gate {g} is not active: it is an energy recognised and received from others and from the environment, rather than a constant of one’s own.',
    ...
    channelBoth:
      'With both of its gates active, the channel is complete: it defines the two centres it connects and creates a steady current of energy between them.',
    channelComplete:
  ...
  reportShell: {
    ...
    centersTitle: 'Your centres and your conditioning',
    ...
    closingPrompt:
      'According to Human Design I am a {type}, with a {profile} profile, {authority} authority, the "{strategy}" strategy and {definition}; my defined centres are: {centers}. I would like to know more about...',
    noCenters: 'none'
  },
  ...
  concept: {
    bodygraph: {
      title: 'The bodygraph',
      paragraphs: [
        'The **bodygraph** is the diagram of the body on which the chart is drawn: the nine geometric shapes are the [centres](concept:center) and the lines connecting them are the [channels](concept:channel), which run from one gate to another. Each centre governs a specific function and, together, they map how energy flows.',
        'What makes every chart unique is which of those [centres](concept:center), [channels](concept:channel) and [gates](concept:gate) are active: type, authority and a person’s way of working all come out of that combination.',
        'The key distinction is whether each centre is **defined** or **undefined** (open). A **defined** centre — coloured in on the bodygraph — works in a fixed, reliable way: a consistent energy, one’s own and constant. An **undefined** centre — shown empty — is not a flaw: it is an open area where the energy of others and of the environment is taken in and amplified; it is where most is learned, but also where it is easy to be conditioned and to mistake what is borrowed for what is one’s own.'
      ]
    },
    type: {
      title: 'The types',
      paragraphs: [
        '**Type** is the first and most important distinction in a chart: it describes how a person’s energy is designed to interact with the world. There are five — [Generator](type:generator), [Manifesting Generator](type:manifesting-generator), [Projector](type:projector), [Manifestor](type:manifestor) and [Reflector](type:reflector) — and they are determined by which centres are defined and how they connect to the [Throat](center:throat).',
    ...
    authority: {
      ...
      paragraphs: [
        ...
        'There are seven: emotional (Solar plexus), sacral, splenic (Spleen), ego (Heart), self-projected (G), mental/environmental and lunar. They are determined by a hierarchy based on the defined centres. Some operate **in the moment** (sacral and splenic) and others need **time** (emotional, which asks you to ride out the emotional wave before clarity arrives).',
    ...
    profile: {
      title: 'The profile',
      paragraphs: [
        'The **profile** describes the "how" of each person’s path: the style in which they learn, relate and fulfil their purpose. It is made of two numbers (3/5, for example), taken from lines 1 to 6 of the I Ching: the first comes from the Sun/Earth of *personality* and the second from the Sun/Earth of *design*.',
        'Each line adds a nuance: 1- foundation and research, 2- natural talent, 3- trial and error, 4- bonds and network, 5- projection and practical leadership, 6- example and maturity. The combination of the **two lines** describes a recognisable way of moving through life — more inward or more relational, more experimental or more solid.',
        'While type and authority answer *how to decide*, the profile answers *how experience unfolds*. It is one of the most revealing layers for self-knowledge, because it usually describes patterns a person already recognises in their own history. Of the two lines, the first is lived more consciously and the second more unconsciously. The unconscious line is generally more visible to others than to oneself.'
      ]
    },
    definition: {
      title: 'Definition',
      paragraphs: [
        '**Definition** describes how the defined centres of a chart are connected to each other: whether they form a single block of energy or several separate groups. It speaks of inner consistency — which parts of a person are always "switched on" and linked — and of how that energy is integrated.',
        'The variants are: no definition ([Reflector](type:reflector), no centre defined), single (everything connected in one group), split (two groups), triple split (three) and quadruple split (four). Single definition tends to feel **self-sufficient**; split definitions usually experience a **search for connection**, often through other people or through specific gates that bridge the groups.',
    ...
    center: {
      title: 'The centres',
      paragraphs: [
        'The **centres** are the nine energy hubs of the bodygraph, each tied to a specific function. They inherit the idea of the chakras, but here what matters is whether each centre is **defined** or **undefined** (open). The nine centres and their functions are:'
      ],
      after: [
        'A **defined** centre works in a fixed, reliable way: a consistent energy that is always contributed, one’s own and constant. An **undefined** centre is not a flaw: it is an open area where the energy of others and of the environment is taken in and amplified; it is where most is learned, but also where it is easy to be conditioned and to mistake what is borrowed for what is one’s own.',
        'Looking at the centres is one of the most practical keys to **managing energy**: the defined ones mark what you offer steadily, and the undefined ones mark where it is wise not to make decisions under borrowed pressure.'
      ]
    },
    channel: {
      title: 'The channels',
      paragraphs: [
        'The **channels** are the 36 connections of the bodygraph: each joins two gates sitting in different centres. A **complete** channel — with both of its gates active — links those two centres, defines them, and creates a steady, reliable current of energy between them.',
        'Taken together, the channels are what determine **type, definition and which centres are defined**. That makes them the mechanical backbone of the chart: they don’t describe an isolated trait, but a constant way in which two areas of energy work together.',
    ...
    gate: {
      title: 'The gates',
      paragraphs: [
        'The **gates** are the 64 possible activations of the bodygraph, one for each I Ching hexagram. Each gate lives in a specific centre and adds a particular nuance of energy or character; at birth, the planets "switch on" a set of them.',
        'An active gate that doesn’t find its partner — the one at the other end of its channel — is left **hanging**: it contributes its theme but seeks completion, often through another person who has the complementary gate. When both gates of a channel are active, the channel forms and defines its two centres.',
    ...
    activation: {
      ...
      paragraphs: [
        '**Activations** are the positions of the planets at the moment of birth, translated into Human Design gates and lines. Each body "switches on" a specific gate (and its line), and the set of all of them is what builds the chart: centres, channels, type, authority and profile.',
        ...
        'They don’t all carry the same weight: the **Sun and Earth** concentrate most of the meaning and the rest add nuance; the *Weight* column summarises that relative influence. Tap an activation to open the corresponding gate. And to see the lines, look at the possible lines in the [profile](concept:profile).'
      ]
    }
  },
  ...
  type: {
    generator: {
      title: 'Generator',
      paragraphs: [
        'The majority type, the *pure* Generator: around **37% of the population**. Its defining feature is the defined [Sacral centre](center:sacral): the life-force engine of the system, generative and renewable in character. Its generating, building energy, when well aligned, is sustained and abundant.',
        ...
        'In practice, its Sacral centre responds before its mind does: faced with something concrete — a proposal, a question, a situation — a gut reaction of attraction or rejection arises. **Following that bodily signal**, rather than deciding from thought and reason, is what keeps its energy well spent.'
      ]
    },
    ...
    projector: {
      ...
      paragraphs: [
        ...
        'Its strategy is to **wait for the invitation** for the important things — work, love, where to live. It needs to be recognised and invited for its wisdom and its effort to be well received; when it offers itself or steps in unasked, it usually meets resistance and rejection. When *recognition* and *success* show up in its life, they are the clue that it is on the right track. The symptom that appears when it isn’t living in alignment is *bitterness*.',
    ...
    reflector: {
      title: 'Reflector',
      paragraphs: [
        'The rarest type: barely **1% of the population**. It has no defined centre at all: its whole bodygraph is open. That makes it an extraordinarily sensitive mirror of the people and places around it, able to sense the health of a community.',
  ...
  strategy: {
    respond: {
      ...
      paragraphs: [
        ...
        'The response arises in the [Sacral centre](center:sacral) as a **gut reaction**, prior to reasoning: an impulse to move towards or to pull away. A yes or a no. Trusting that bodily yes or no, instead of talking yourself into it, is what leads to satisfaction; forcing action where there is no response leads to frustration.'
      ]
    },
    'respond-then-inform': {
    ...
    'wait-for-invitation': {
      ...
      paragraphs: [
        'The Projector’s strategy. For the important things — a job, a relationship, a big commitment — the design asks it to **wait to be recognised and invited** instead of offering itself unasked.',
  ...
  authority: {
    ...
    sacral: {
      ...
      paragraphs: [
        'The authority of most Generators. It lives in the **[Sacral centre](center:sacral)**, which responds **in the moment** with a sound or a gut impulse — a kind of "uh-huh" of attraction or an "mm-mm" of rejection — to something concrete: the body *says* yes or no.',
    ...
    splenic: {
      ...
      paragraphs: [
        'It lives in the **[Spleen](center:spleen)**, the oldest centre of awareness, tied to survival, health and instinct. It speaks **in the present and only once**: a sudden, quiet, spontaneous knowing, with no repetition and no argument.',
        'It is the most **subtle and fleeting** authority: it doesn’t insist or argue, so it is easy to overlook or to rationalise away afterwards. Whoever has it learns to **trust that first instinctive impulse** — that calm bodily "yes" or "no" — the instant it appears, because it usually doesn’t speak twice.'
      ]
    },
    ego: {
      title: 'Ego authority',
      paragraphs: [
        'It lives in the **[Heart centre (Ego)](center:heart)**, the engine of willpower and desire. Here the right decision is recognised through an honest question: **do I really want this? what’s in it for me?** This is not selfishness, but honouring what you actually want.',
    ...
    'self-projected': {
      ...
      paragraphs: [
        'Particular to certain Projectors. Truth arrives through the **voice**: by talking the matter through out loud, the person **hears themselves** and recognises what is consistent with their identity and their direction.',
    ...
    mental: {
      ...
      paragraphs: [
        'Also called environmental authority or "sounding board", particular to some Projectors with no inner centres defined for deciding. There is no fixed inner bodily authority: clarity doesn’t arrive from within all at once, **clarity comes from dialogue**.',
    ...
    lunar: {
      ...
      paragraphs: [
        'The Reflector’s authority, the only type with no defined centre at all. With no fixed inner source, the guide is **time**: a full lunar cycle, about 28 days, before important decisions.',
  ...
  definition: {
    'no-definition': {
      title: 'No definition',
      paragraphs: [
        'Unique to the Reflector: **no centre is defined**, the whole bodygraph stays open. There is no fixed energy of its own; instead, the person takes in, amplifies and reflects the energy of those around them.',
    ...
    single: {
      ...
      paragraphs: [
        'All the defined centres are **connected in a single block**. Energy flows internally without interruption, which gives a sense of **self-sufficiency**: the person has access to their own consistency without depending on others to "complete" them.',
        'Their challenge tends to be the opposite of the split definitions’: because they work well on their own, they can become self-absorbed or find it hard to open up to outside influence. Recognising when it is worth stepping out of their own bubble is part of their learning.'
      ]
    },
    split: {
      title: 'Split definition',
      paragraphs: [
        'The defined centres form **two separate groups**, with no channel joining them internally. The person usually experiences a **search for connection**: something to bridge their two parts.',
    ...
    'triple-split': {
      ...
      paragraphs: [
        'The defined centres are spread across **three separate groups**. The internal wiring is more complex and the person often needs **more variety of stimulation and of people** to feel their inner parts connect.',
    ...
    'quad-split': {
      ...
      paragraphs: [
        'The rarest: the defined centres form **four separate groups**. It is a highly fragmented wiring that, paradoxically, usually calls for **more structure, space and calm** in order to integrate.',
  ...
  center: {
    head: {
      title: 'Head',
      fn: 'A centre of **mental pressure**: the force that pushes us to think, to question and to be inspired. It generates the questions and the curiosity, but it doesn’t answer them — that is the [Ajna](center:ajna)’s job.',
    ...
    ajna: {
      title: 'Ajna',
      fn: 'The centre of the **mind and conceptualisation**: it processes information, forms ideas and gives structure to what we think, working with the pressure arriving from the [Head](center:head).',
    ...
    throat: {
      title: 'Throat',
      fn: 'The centre of **communication and manifestation**: where energy turns into voice and into action. Everything that is expressed or made real passes through here.',
    ...
    g: {
      title: 'G',
      fn: 'The centre of **identity, love and direction**: the sense of who you are and where your life is heading. It is also tied to the feeling of being in the right place.',
    ...
    heart: {
      title: 'Heart (Ego)',
      fn: 'The centre of **willpower, ego and self-worth**, tied to the material world and to the ability to commit and keep promises. It is a motor that works in pulses of willpower, not continuously.',
    ...
    sacral: {
      ...
      open: '**Undefined**, it doesn’t have that constant energy: here it is vital to **recognise when enough is enough** and not to be dragged along by other people’s pace to the point of exhaustion.'
    },
    spleen: {
      title: 'Spleen',
      fn: 'The centre of **instinct, intuition and survival**, tied to the immune system, health and the sense of wellbeing in the present. It speaks quietly, in the now, and only once.',
    ...
    solarPlexus: {
      title: 'Solar plexus',
      fn: 'The centre of **emotions, feelings and moods**, which works in **waves** that rise and fall over time. When it is defined, it sets an emotional authority: **there is no truth in the moment**.',
    ...
    root: {
      title: 'Root',
      fn: 'A centre of **pressure and adrenaline**: the drive that gets us moving and the stress that urges us to act in order to be free of that pressure. It gives the pulse to get things started.',
  ...
  activationCol: {
    personality: {
      ...
      paragraphs: [
        'The **Personality** column represents the **conscious** side: what the person recognises as "me", their mind and their personality. It is calculated from the position of the planets at the **exact instant of birth**.',
    ...
    weight: {
      ...
      paragraphs: [
        ...
        'The *Weight* column summarises that relative influence as a rough guide (**high / medium / low**). It is an approximation, not an official figure of the system: use it to know where to start reading the chart — always with the Sun and the Earth.'
      ]
    }
  },
  ...
  planet: {
    ...
    earth: {
      title: 'Earth',
      paragraphs: [
        'The **Earth** balances the Sun: it is what **grounds and stabilises**, the floor on which the purpose rests. With the Sun it forms the most decisive axis of the chart.',
        'It provides the practical counterweight to the solar energy: what is needed to stay centred.'
      ]
    },
    moon: {
      title: 'Moon',
    ...
    northNode: {
      title: 'North Node',
      paragraphs: [
        'The **North Node** describes the **direction and environment** the second half of life orients towards (roughly, from maturity onwards). It marks where life is heading.',
  ...
  gate: {
    ...
    7: { theme: 'leadership and direction', text: 'Gate 7 is the **guiding role towards the future**: the capacity to give direction and to lead, often from the background. Its gift is a natural authority others want to follow; its shadow, the need to control the course or to impose itself.' },
    ...
    17: { theme: 'opinions', text: 'Gate 17 is the mind that **forms opinions** and anticipates in order to organise. Its gift is useful opinions that give structure; its shadow, presenting as facts what are only views.' },
    ...
    24: { theme: 'rationalisation', text: 'Gate 24 is the mind that **returns again and again to a thought** until it makes sense of it. Its gift is the revelation born of revisiting; its shadow, the obsessive loop there is no way out of.' },
    ...
    33: { theme: 'retreat and the telling', text: 'Gate 33 is **retreat and the telling**: withdrawing in order to later recount what was lived. Its gift is a wisdom shared after reflection; its shadow, not honouring the need to withdraw, or telling too much or too little.' },
    ...
    44: { theme: 'the instinct for the past', text: 'Gate 44 is the **instinct that reads the past**: an alertness for recognising patterns, people and opportunities. Its gift is a nose for people and timing; its shadow, the fear that the past will repeat itself.' },
    ...
    47: { theme: 'mental realisation', text: 'Gate 47 is **realisation**: the mental pressure to make sense of confusion until the "aha" arrives. Its gift is resolving the confusing into clear understanding; its shadow, getting trapped in a sense of oppression or meaninglessness.' },
    ...
    62: { theme: 'detail and order', text: 'Gate 62 is **detail and organisation**: naming and ordering things in order to express them precisely. Its gift is a clear, orderly expression; its shadow, getting lost in detail or over-explaining.' },
  ...
  report: {
    ...
    chart: {
      title: 'The bodygraph',
      paragraphs: [
        'Your chart is drawn on a diagram of the body called the **bodygraph**: the nine geometric shapes are the centres and the lines connecting them are the channels, which run from one gate to another (there are 64 gates). Each centre governs a specific function and, together, they map how your energy flows.',
        'What makes your chart unique is which of those centres, channels and gates are active: the coloured centres are defined and the ones that look empty are open. Your type, your authority and your way of functioning all come out of that combination, and that is what we will unpack next.'
      ]
    },
    conditioning: {
      title: 'Defined, undefined and conditioning',
      paragraphs: [
        'A defined centre works in a fixed, reliable way: it is an energy of yours, constant, that you always contribute and that doesn’t depend on who is beside you. An undefined (open) centre is not a flaw: it is an area where you don’t have that fixed energy and where, instead, you absorb and amplify other people’s and the environment’s.',
        'Human Design calls everything that pulls us away from living according to our design **conditioning**: the layers we accumulate — through upbringing, culture, fears or what is expected of us — that lead us to act as we are not. Your open centres are the main entry point for that conditioning. Recognising it is the first step of the [deconditioning](section:experiment) we mentioned earlier: gradually letting go of what is borrowed in order to come back to yourself, paying particular attention to no longer comparing yourself with how other people and other designs work.'
      ]
    },
    experiment: {
    ...
    collective: {
      ...
      bullets: [
        ...
        '**Projectors (~20%)**: they don’t have that constant energy; their gift is to see, guide and direct others. They shine when they are recognised and invited, not by forcing themselves to a Generator’s pace.',
    ...
    leadIn: {
      ...
      definition: 'Definition describes how your defined centres group together: whether they form a single block or several separate groups.',
      ...
      centers: 'The nine centres in your chart:'
    },

    type: {
      generator: [
        'You are the majority type, a *pure* Generator — around **37% of the population**. Your defining feature is the defined [Sacral centre](center:sacral): the life-force engine of the system, generative and renewable in character. Your generating, building energy, when you are well aligned, is sustained and abundant.',
        ...
        'In practice, your Sacral centre responds before your mind does: faced with something concrete — a proposal, a question, a situation — a gut reaction of attraction or rejection arises. **Following that bodily signal**, rather than deciding from thought and reason, is what keeps your energy well spent.'
      ],
      'manifesting-generator': [
      ...
      reflector: [
        'You are the rarest type: Reflectors are barely **1% of the population**. You have no defined centre at all: your whole bodygraph is open. That makes you an extraordinarily sensitive mirror of the people and places around you, able to sense the health of a community.',
    ...
    strategy: {
      ...
      'wait-for-invitation': [
        'For the important things — a job, a relationship, a big commitment — your design asks you to **wait to be recognised and invited** instead of offering yourself unasked.',
    ...
    authority: {
      ...
      sacral: [
        'Your authority lives in the **[Sacral centre](center:sacral)**, which responds **in the moment** with a sound or a gut impulse — a kind of "uh-huh" of attraction or an "mm-mm" of rejection — to something concrete: the body *says* yes or no.',
      ...
      splenic: [
        'Your authority lives in the **[Spleen](center:spleen)**, the oldest centre of awareness, tied to survival, health and instinct. It speaks **in the present and only once**: a sudden, quiet, spontaneous knowing, with no repetition and no argument.',
        'It is the most **subtle and fleeting** authority: it doesn’t insist or argue, so it is easy to overlook or to rationalise away afterwards. Your practice is to **trust that first instinctive impulse** — that calm bodily "yes" or "no" — the instant it appears, because it usually doesn’t speak twice.'
      ],
      ego: [
        'Your authority lives in the **[Heart centre (Ego)](center:heart)**, the engine of willpower and desire. Here you recognise the right decision through an honest question: **do I really want this? what’s in it for me?** This is not selfishness, it is honouring what you actually want.',
      ...
      'self-projected': [
        'Your truth arrives through the **voice**: by talking the matter through out loud, **you hear yourself** and recognise what is consistent with your identity and your direction.',
      ...
      lunar: [
        'As a Reflector you have no defined centre, so there is no fixed inner source in you: your guide is **time**, a full lunar cycle — about 28 days — before important decisions.',
    ...
    definition: {
      'no-definition': [
        '**No centre is defined**, your whole bodygraph stays open. You don’t have a fixed energy of your own; instead, you take in, amplify and reflect the energy of those around you.',
      ...
      single: [
        'All your defined centres are **connected in a single block**. Your energy flows internally without interruption, which gives you a sense of **self-sufficiency**: you have access to your own consistency without depending on others to "complete" you.',
        'Your challenge tends to be the opposite of the split definitions’: because you work well on your own, you can become self-absorbed or find it hard to open up to outside influence. Recognising when it is worth stepping out of your own bubble is part of your learning.'
      ],
      split: [
        'Your defined centres form **two separate groups**, with no channel joining them internally. That is why you usually experience a **search for connection**: something to bridge your two parts.',
      ...
      'triple-split': [
        'Your defined centres are spread across **three separate groups**. Your internal wiring is more complex and you often need **more variety of stimulation and of people** to feel your inner parts connect.',
      ...
      'quad-split': [
        'The rarest: your defined centres form **four separate groups**. It is a highly fragmented wiring that, paradoxically, usually calls for **more structure, space and calm** in order to integrate.',
    ...
    center: {
      head: {
        defined: 'This is one of your **defined** centres: you have a constant way of being inspired and of feeling the pressure to understand.',
        open: 'This is one of your **open** centres: you amplify other people’s questions and mental restlessness, and it is wise not to be dragged into resolving doubts that aren’t really yours and don’t matter for your life.'
      },
      ajna: {
        defined: 'This is one of your **defined** centres: you have a fixed and reliable way of thinking, with stable opinions and certainties.',
        open: 'This is one of your **open** centres: your mind is flexible, able to see many perspectives; your trap is the pressure to appear certain or to cling to a borrowed certainty, and your gift is not needing to always have a fixed answer.'
      },
      throat: {
        defined: 'This is one of your **defined** centres: you have a consistent voice and way of expressing yourself.',
        open: 'This is one of your **open** centres: you adapt your way of communicating to the company and may feel the pressure to speak in order to be noticed; your learning is to wait for the right moment instead of forcing words.'
      },
      g: {
        defined: 'This is one of your **defined** centres: you have a stable sense of identity and direction.',
        open: 'This is one of your **open** centres: your identity is more fluid and changing, and it finds its direction through the right environments and people; your key is **place**: being in the right spot orients everything else.'
      },
      heart: {
        defined: 'This is one of your **defined** centres: you have a consistent will and the capacity to sustain what you promise.',
        open: 'This is one of your **open** centres (as in most people): you don’t need to prove your worth or measure your willpower, and your trap is over-promising to prove yourself. Here you learn that your worth doesn’t depend on your achievements.'
      },
      sacral: {
        defined: 'This is one of your **defined** centres: you have a sustainable, renewable working energy, meant to be spent fully on the right things and healthily used up each day.',
        open: 'This is one of your **open** centres: you don’t have that constant energy, so it is vital for you to recognise when enough is enough and not to be dragged along by other people’s pace to the point of exhaustion.'
      },
      spleen: {
        defined: 'This is one of your **defined** centres: you have a constant intuition and sense of health.',
        open: 'This is one of your **open** centres: you amplify other people’s fears and tend to hold on to what isn’t good for you — relationships, habits, situations — out of fear of letting go; your learning is not to decide from fear and to discover what actually suits your body.'
      },
      solarPlexus: {
        defined: 'This is one of your **defined** centres: you live your own emotional waves and need time to reach clarity.',
        open: 'This is one of your **open** centres: you absorb and amplify the emotions around you — you pick up the mood of a room — and tend to avoid confrontation; your challenge is not to take ownership of moods you have actually picked up from outside.'
      },
      root: {
        defined: 'This is one of your **defined** centres: you have a constant way of handling pressure and stress.',
        open: 'This is one of your **open** centres: you amplify hurry and the feeling of having to get pending things off your plate as soon as possible; your learning is not to be pushed into rushed decisions just to relieve a pressure that is, in large part, borrowed.'
      }
    }
  },
  ...
  channel: {
    ...
    '17-62': { name: 'channel of acceptance', essence: 'opinions that arrange themselves into data and detail in order to organise and anticipate.' },
  ...
  // Short keynote per centre, shown next to the chips in the centres drawer.
  centerBrief: {
  ...
  relatedIndex: {
    ...
    authority: {
      ...
      items: {
        ...
        'self-projected': { label: 'Self-projected', note: 'hearing yourself speak out loud to recognise yourself' },
    ...
    definition: {
      ...
      items: {
        'no-definition': { label: 'No definition', note: 'no centre defined (Reflector)' },
    ...
    profile: {
      ...
      items: {
        ...
        '6': { label: 'Line 6', note: 'the role model: three phases towards example' }
      }
    }
  },
